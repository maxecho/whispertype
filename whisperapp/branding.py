...
WORDS_HINT = (
    "Одна замена в строке, слева — как слышится, справа — как писать.\n"
...
PROMPT_HINT = (
    ...
    "Работает мягче словаря: это подсказка, а не жёсткая замена.\n\n"
    "Например: названия компаний, фамилии коллег, профессиональный жаргон."
)
