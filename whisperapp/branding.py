...
MENU_LANGUAGE = "Язык"
MENU_WORDS = "Словарь замен…"
MENU_PROMPT = "Подсказка распознаванию…"
MENU_PASTE = "Вставлять сразу в поле"
MENU_SOUNDS = "Звук в начале и в конце"
MENU_GLOW = "Подсветка по краям экрана"
MENU_LIVE = "Показывать текст по ходу речи"
...
WORDS_HINT = (
    "Слева — как программа НАПИСАЛА, справа — как надо. Одна замена в строке.\n"
    "Слева пишите ровно то, что увидели в тексте: замена ищется по написанному, "
    "а не по звучанию.\n"
    "Регистр первой буквы подставится сам.\n\n"
    "Hype = Hybe\n"
    "Шакала = Шокало\n"
    "офер = оффер"
)
...
PROMPT_HINT = (
    "Перечислите через запятую имена и термины из вашей речи — распознавание "
    "будет их ждать и реже перевирать.\n\n"
    "Работает мягче словаря: это подсказка на входе, а не замена в готовом "
    "тексте. Помогает и с теми словами, которые программа коверкает "
    "каждый раз по-новому — их словарём не переловить.\n\n"
    "Например: Hybe, BDM, медиаплан, оффер, CPM, инвентарь, Шокало, Мачехин."
)
